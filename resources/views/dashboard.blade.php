        ...
        <div class="container-fluid px-4">
            ...
            <div class="row mb-5">
                <div class="col-12">
                    ...
                    <div class="card border-0 rounded-4 text-white overflow-hidden position-relative shadow-lg"
                        ...
                        <div
                            class="card-body p-4 p-lg-5 position-relative z-1 d-flex align-items-center justify-content-between flex-wrap">
                            <div class="d-flex align-items-center mb-3 mb-md-0">
                                <div
                                    class="bg-white bg-opacity-25 p-3 rounded-circle me-4 shadow-sm backdrop-blur border border-white border-opacity-50">
                                    @if ($role === 'admin')
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 opacity-90 fw-light">
                                        ...
                                        @elseif($role == 'parent')
                                            Pantau perkembangan buah hati Anda.
                                        @else
                            ...
                            <div
                                class="text-end d-none d-lg-block bg-white bg-opacity-10 p-3 rounded-3 backdrop-blur border border-white border-opacity-25">
            ...
            @if ($role === 'admin')
                        ...
                        <div class="card border-0 rounded-4 shadow-sm h-100 hover-up bg-white">
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                                        <p class="text-muted small fw-bold text-uppercase mb-1">Total Siswa</p>
                                        <h2 class="fw-bold text-dark mb-0">{{ $total_siswa ?? 0 }}</h2>
                                    </div>
                                    <div class="icon-box bg-primary bg-opacity-10 text-primary rounded-3"><i
                                            class="fas fa-users"></i></div>
                                </div>
                                <div class="mt-3"><span
                                        class="badge bg-success bg-opacity-10 text-success rounded-pill px-2"><i
                                            class="fas fa-check-circle me-1"></i> Data Aktif</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card border-0 rounded-4 shadow-sm h-100 hover-up bg-white">
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                                        <p class="text-muted small fw-bold text-uppercase mb-1">Total Guru</p>
                                        <h2 class="fw-bold text-dark mb-0">{{ $total_guru ?? 0 }}</h2>
                                    </div>
                                    <div class="icon-box bg-warning bg-opacity-10 text-warning rounded-3"><i
                                            class="fas fa-chalkboard-teacher"></i></div>
                                </div>
                                <div class="mt-3"><span
                                        class="badge bg-info bg-opacity-10 text-info rounded-pill px-2"><i
                                            class="fas fa-user-tie me-1"></i> Pengajar</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card border-0 rounded-4 shadow-sm h-100 hover-up bg-white">
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                                        <p class="text-muted small fw-bold text-uppercase mb-1">Total Kelas</p>
                                        <h2 class="fw-bold text-dark mb-0">{{ $total_kelas ?? 0 }}</h2>
                                    </div>
                                    <div class="icon-box bg-info bg-opacity-10 text-info rounded-3"><i
                    ...
                    <div class="col-md-3">
                        <div class="card border-0 rounded-4 shadow-sm h-100 hover-up bg-white">
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                                        <p class="text-muted small fw-bold text-uppercase mb-1">Mapel</p>
                                        <h2 class="fw-bold text-dark mb-0">{{ $total_mapel ?? 0 }}</h2>
                                    </div>
                                    <div class="icon-box bg-success bg-opacity-10 text-success rounded-3"><i
                ...
                <div class="row g-3">
                    @php
                        $menus = [
                            [
                                'route' => 'guru.data.subjects.index',
                                'icon' => 'fa-book',
                                'color' => 'primary',
                                'label' => 'Mapel',
                                'desc' => 'Kelola Mapel',
                            ...
                            [
                                'route' => 'guru.data.classrooms.index',
                                'icon' => 'fa-chalkboard',
                                'color' => 'success',
                                'label' => 'Kelas',
                            ...
                            [
                                'route' => 'guru.data.teachers.index',
                                'icon' => 'fa-user-tie',
                                'color' => 'warning',
                                'label' => 'Guru',
                                'desc' => 'Data Pengajar',
                            ...
                            [
                                'route' => 'guru.data.students.index',
                                'icon' => 'fa-user-graduate',
                                'color' => 'info',
                                'label' => 'Siswa',
                                'desc' => 'Data Peserta Didik',
                            ],
                            [
                                'route' => 'guru.data.parents.index',
                            ...
                            [
                                'route' => 'guru.data.allocations.index',
                                'icon' => 'fa-project-diagram',
                                'color' => 'secondary',
                                'label' => 'Plotting',
                                'desc' => 'Distribusi Guru',
                            ],
                            [
                    ...
                    @foreach ($menus as $menu)
                        <div class="col-md-4 col-xl-2">
                            <a href="{{ route($menu['route']) }}" class="text-decoration-none">
                                <div
                                    class="card border-0 rounded-4 shadow-sm h-100 hover-scale text-center py-4 bg-white">
                                    <div class="card-body">
                                        <div class="avatar-lg bg-{{ $menu['color'] }} bg-opacity-10 text-{{ $menu['color'] }} rounded-circle mx-auto mb-3 d-flex align-items-center justify-content-center"
                                            style="width: 60px; height: 60px;">
                                            <i class="fas {{ $menu['icon'] }} fa-lg"></i>
                                        </div>
                                        <h6 class="fw-bold text-dark mb-1">{{ $menu['label'] }}</h6>
                                        <small class="text-muted d-block lh-sm"
                                            style="font-size: 11px;">{{ $menu['desc'] }}</small>
                                    </div>
                                </div>
                            </a>
                        </div>
            ...
            @elseif($role === 'teacher')
                <div class="row g-4">
                        ...
                        <div class="card border-0 rounded-4 shadow-sm h-100 bg-white">
                            <div
                                ...
                                <h5 class="fw-bold text-dark mb-0"><i
                                        class="fas fa-calendar-day text-primary me-2"></i>Jadwal Mengajar Hari Ini</h5>
                                <a href="{{ route('guru.jadwal.index') }}"
                                    class="btn btn-sm btn-light rounded-pill px-3 fw-bold small text-primary border">Lihat
                                    Semua</a>
                            </div>
                            <div class="card-body p-4">
                                ...
                                @else
                                    <div class="text-center py-5">
                                        <div class="bg-light rounded-circle d-inline-flex p-4 mb-3"><i
                                                class="fas fa-coffee fa-3x text-secondary opacity-50"></i></div>
                    ...
                    <div class="col-lg-4">
                        <div class="card border-0 rounded-4 shadow-sm bg-gradient-primary text-white mb-4 position-relative overflow-hidden"
                            style="background: linear-gradient(45deg, #3a7bd5, #3a6073);">
                            ...
                            <i class="fas fa-layer-group position-absolute text-white"
                                style="bottom: -20px; right: -20px; font-size: 100px; opacity: 0.1;"></i>
                        </div>
                        <div class="card border-0 rounded-4 shadow-sm bg-white">
                            <div class="card-header bg-transparent border-0 pt-4 px-4 pb-2">
                                <h6 class="fw-bold text-gray-800">Aksi Cepat</h6>
                            </div>
                            <div class="card-body p-2">
                                <div class="list-group list-group-flush">
                                    <a href="{{ route('guru.absensi.index') }}"
                                        class="list-group-item list-group-item-action border-0 rounded-3 p-3 mb-1 d-flex align-items-center hover-bg-light">
                                        <div class="bg-success bg-opacity-10 text-success rounded-3 p-2 me-3"><i
                                                class="fas fa-user-check fa-lg"></i></div>
                                        <div>
                                            <h6 class="fw-bold text-dark mb-0">Rekap Absensi</h6>
                                        </div>
                                    </a>
                                    <a href="{{ route('guru.nilai.index') }}"
                                        class="list-group-item list-group-item-action border-0 rounded-3 p-3 mb-1 d-flex align-items-center hover-bg-light">
                                        <div class="bg-warning bg-opacity-10 text-warning rounded-3 p-2 me-3"><i
                                                class="fas fa-star fa-lg"></i></div>
                                        <div>
                                            <h6 class="fw-bold text-dark mb-0">Input Nilai</h6>
                                        </div>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card border-0 rounded-4 shadow-sm h-100 bg-white">
                            <div class="card-body p-4 text-center">
                                @if (isset($anak))
                                    <div class="mb-3">
                                        <img src="https://ui-avatars.com/api/?name={{ urlencode($anak->nama_lengkap) }}&background=random&size=128"
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <a href="{{ route('ortu.perkembangan.index') }}" class="text-decoration-none">
                                    <div
                                        class="card border-0 rounded-4 shadow-sm bg-white hover-up p-4 d-flex flex-row align-items-center justify-content-between">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-muted mb-0 small">Cek Absensi, Nilai, dan Catatan Wali
                        ...
                        <div class="card border-0 rounded-4 shadow-sm bg-white overflow-hidden">
                            <div
                                ...
                                <h6 class="fw-bold text-dark"><i
                                        class="fas fa-file-invoice-dollar text-danger me-2"></i>Tagihan Belum Lunas
                                </h6>
                                <a href="{{ route('ortu.tagihan.index') }}"
                                    class="btn btn-sm btn-light border rounded-pill px-3 fw-bold small text-muted">Lihat
                                    Semua</a>
                            </div>
                                                ...
                                                <tr>
                                                    <td class="ps-4">
                                                        @if ($tagihan->title)
                                                            ...
                                                            <div class="small text-muted">{{ $tagihan->month }}
                                                                {{ $tagihan->year }}</div>
                                                        @else
                                                            <div class="fw-bold text-dark">{{ $tagihan->month }}
                                                                {{ $tagihan->year }}</div>
                                                        @endif
                                                    </td>
                                                    ...
                                                    <td>
                                                        @if ($tagihan->dispensation_status == 'pending')
                                                            <span
                                                                class="badge bg-warning text-dark rounded-pill">Dispensasi
                                                                Pending</span>
                                                        @elseif($tagihan->dispensation_status == 'approved')
                                                            <span
                                                                class="badge bg-info text-dark rounded-pill">Dispensasi
                                                                Disetujui</span>
                                                        @else
                                                            <span
                                                                class="badge bg-danger bg-opacity-10 text-danger rounded-pill">Belum
                                                                Bayar</span>
                                                        @endif
                                                    </td>
                                                </tr>
                    ...
                    <div class="col-lg-8">
                        <div class="card border-0 rounded-4 shadow-sm h-100 bg-white">
                            <div class="card-header bg-transparent border-0 pt-4 px-4 pb-0">
                                <h5 class="fw-bold text-dark mb-0"><i
                                        class="fas fa-book-open text-primary me-2"></i>Mata Pelajaran Hari Ini</h5>
                            </div>
                            <div class="card-body p-4">
                                @if (isset($jadwal_hari_ini) && count($jadwal_hari_ini) > 0)
                                    <div class="row g-3">
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <a href="{{ route('siswa.rapor') }}"
                                    class="card border-0 rounded-4 shadow-sm text-decoration-none hover-scale overflow-hidden h-100 bg-white">
                                    <div
                                        class="card-body p-4 d-flex justify-content-between align-items-center position-relative">
                                        <div>
                                            <h5 class="fw-bold text-dark mb-1">E-Rapor</h5>
                                            <p class="text-muted small mb-0">Lihat Hasil Belajar</p>
                                        </div>
                                        <div class="bg-success bg-opacity-10 p-3 rounded-circle text-success z-1"><i
                                ...
                                <a href="{{ route('siswa.jadwal') }}"
                                    ...
                                    <div
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted small mb-0">Jadwal Akademik</p>
                                        </div>
                                        <div class="bg-info bg-opacity-10 p-3 rounded-circle text-info z-1"><i
                                                class="fas fa-calendar-week fa-2x"></i></div>
                                    </div>
                                </a>
                            </div>
                        </div>
