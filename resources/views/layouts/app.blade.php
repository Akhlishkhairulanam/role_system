        ...
        <nav id="sidebar">
            <div class="sidebar-header">
                <div class="d-flex align-items-center">
                    <div class="bg-primary rounded-3 p-2 me-3 d-flex align-items-center justify-content-center shadow-lg"
                    ...
                    @if (auth()->user()->role === 'parent')
                        ...
                        <li class="{{ request()->routeIs('ortu.tagihan.*') ? 'active' : '' }}">
                            <a href="{{ route('ortu.tagihan.index') }}"
                                ...
                                @if ($unpaidCount > 0)
                                    <span class="badge bg-danger rounded-pill fw-bold blink-soft"
            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container-fluid">
                    ...
                    <div class="ms-auto d-flex align-items-center gap-3">
                        ...
                        <div class="rounded-circle bg-white border p-1 shadow-sm"
